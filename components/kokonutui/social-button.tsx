...
export default function SocialButton({
  ...
  const shareButtons = [
    { icon: Twitter, label: "Share on Twitter", link: "https://x.com/Nithin1659568" },
    { icon: Instagram, label: "Share on Instagram", link: "https://www.instagram.com/nithin_th0r/" },
    { icon: Linkedin, label: "Share on LinkedIn", link: "https://www.linkedin.com/in/nithin-balaji-474636333/" },
